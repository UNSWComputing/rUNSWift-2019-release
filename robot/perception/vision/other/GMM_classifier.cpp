...
PCA::PCA(ClassifierType type)
{
    ...
    */
    ...
    switch(type) {
        ...
        case corner:
            pca_model_dir = PCA_MODEL_DIR_CORNER; break;
        case Tjunction:
            pca_model_dir = PCA_MODEL_DIR_T; break;
        default:
            break;
    }
...
ClassConditionalGMM::ClassConditionalGMM(ClassifierType type)
{
    ...
    */
    ...
    switch(type) {
        ...
        case corner:
            gmm_model_dir = GMM_MODEL_DIR_CORNER; break;
        case Tjunction:
            gmm_model_dir = GMM_MODEL_DIR_T; break;
        default:
            break;
    }
